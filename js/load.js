...
(function() {
  var arg, escape, key, on_error, out, py_escape, query, query_args, rs, rs_req, rsu, status, string, string_req, tags, uescape, val, _i, _len, _ref;
  ...
  this.make_link = function() {
    out = $('#output');
    out.css('color', 'black');
    return out.html("http://kirbyfan64.github.io/rs/index.html?script=" + (uescape($('#script').val())) + "&input=" + (uescape($('#input').val())));
  };
